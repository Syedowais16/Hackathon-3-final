...
export default function SecondFooter() {
    return (
      ...
      <section className="w-[79%] sm:w-[100%] mx-auto bg-[#FFFFFF] pt-8 sm:pt-16">
          <div className="w-[94%] flex flex-col gap-4 sm:gap-0 sm:flex-row sm:justify-between sm:items-center">
              <div className="flex flex-col">
                  <h1 className="text-[#252b42] ml-[125%] mb-[30%] mt-[-20%] text-2xl font-bold leading-loose tracking-wider">Bandage</h1>
              </div>
              <div className="flex gap-5 mr-[6%] mb-[3%] mt-[-2%]">
                  <Image src={'/facebook.png'} alt="fb" className="w-6 h-6 " width={24} height={24} />
                  <Image src={'/instagram.png'} alt="insta" className="w-6 h-6 " width={24} height={24} />
                  <Image src={'/twitter.png'} alt="twitter" className="w-6 h-6 " width={24} height={24} />
              </div>
          </div>
  
          <div className="border-t border-[#e6e6e6] " />
          <div className="bg-white mt-3 sm:mt-0 py-24 ">
              <div className="max-w-screen-xl mx-auto flex flex-col sm:grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-7 w-[79%] sm:w-[80%]">
          ...
          <section className="bg-[#F5f5f5] py-4  ">
              <div className="max-w-screen-xl mx-auto flex justify-between items-center">
                  <p className="text-[#727272] text-sm font-bold tracking-widest ml-[8%]">Made with love by Finland. All rights reserved.</p>
              </div>
          </section>
      </section>
  </footer>
